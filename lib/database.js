...
return await githubClearAndWriteFile("settings", "settings.json",JSON.stringify(get))
} else if (setting == "NUMBER_212_BLOCK") {
get.NUMBER_212_BLOCK = data
config.NUMBER_212_BLOCK = data
return await githubClearAndWriteFile("settings", "settings.json",JSON.stringify(get))
...
config.NUMBER_212_BLOCK = get.NUMBER_212_BLOCK  
